...
class PortfolioManager:
    """
    Gestão do portefólio: carrega, guarda e atualiza posições.
    Cada posição pode ter data de compra para melhor análise gráfica/histórica.
    """
    ...
    def calculate_metrics(self, data_provider):
        """
        Calcula métricas agregadas do portefólio para a interface/dash.
        """
        total_value = 0
        total_cost = 0
        total_profit = 0
