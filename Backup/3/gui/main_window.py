...
# Explicações automáticas para features
FEATURE_EXPLANATIONS = {
    ...
    # ... outros indicadores se precisares ...
}
...
class PredictionDialog(QDialog):
    def __init__(self, direction, proba, price_pred, features, multiclass=False, parent=None, class_labels=None):
        ...
        # Explicação automática de cada feature
...
class MainWindow(QMainWindow):
    ...
    def atualizar_sugestoes(self):
        universe = [
            "AAPL", "MSFT", "GOOG", "NVDA", "AMZN", "META", "TSLA", "ORCL",
            "JPM", "V", "MA", "BRK-B", "PG", "KO", "DIS", "PEP", "NFLX"
        ]
        portfolio_tickers = {pos['ticker'] for pos in self.portfolio_manager.positions}
        ...
        for i, ticker in enumerate(tickers_para_analise):
            try:
                ...
                if data is None or data.empty or 'Close' not in data.columns:
                    ...
                    indicadores_txt = self.analyse_indicators_custom(data)
                    try:
    ...
    def analyse_indicators_custom(self, data):
    ...
    def run_backtest(self):
        ...
        try:
            ...
            # TODO: Expansão: exibir gráfico da curva de capital numa aba extra
        except Exception as e:
